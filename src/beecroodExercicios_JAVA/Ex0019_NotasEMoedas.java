...
public class Ex0019_NotasEMoedas {
    public static void main(String[] args) {
        ...
        valor = cash.nextDouble();

        valorint = (int) valor;  //conversão de tipos de dados
        valorMoedas = valor - valorint;
        valorMoedas = Math.round(valorMoedas * 100);  //método para arredondar o número
