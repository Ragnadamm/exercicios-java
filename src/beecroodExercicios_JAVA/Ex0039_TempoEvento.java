...
//Exemplo copiado para servir de base
//Código roda na IDE, mas o BEECROWS não aceita na Q 1061
...
public class Ex0039_TempoEvento {
    public static void main(String[] args) {
        ...
        String[] ShoraInicial = leitor.nextLine().replace(" ", "").split(":");
        String[] SdiaFinal = leitor.nextLine().split(" ");
        String[] ShoraFinal = leitor.nextLine().replace(" ", "").split(":");
